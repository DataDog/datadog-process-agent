...
gofmt -l $REPLACE_MODE -r '"DD_APM_ANALYZED_SPANS" -> "STS_APM_ANALYZED_SPANS"' $REPLACE_SCOPE
...
gofmt -l $REPLACE_MODE -r '"https://process.datadoghq.eu" -> "http://localhost"' $REPLACE_SCOPE
gofmt -l $REPLACE_MODE -r '"process.datadoghq.com" -> "localhost"' $REPLACE_SCOPE
gofmt -l $REPLACE_MODE -r '"process.datadoghq.eu" -> "localhost"' $REPLACE_SCOPE
gofmt -l $REPLACE_MODE -r '"endpoint=https://process.datadoghq.com,https://process.datadoghq.eu" -> "endpoint=http://localhost,http://localhost"' $REPLACE_SCOPE
gofmt -l $REPLACE_MODE -r '"    https://process.datadoghq.eu:" -> "    http://localhost:"' $REPLACE_SCOPE
