...
type CollectorConnections struct {
	...
	// hostId
	ConnectedHosts map[int32]*Host `protobuf:"bytes,7,rep,name=connectedHosts" json:"connectedHosts,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
...
func (m *CollectorConnections) GetConnectedHosts() map[int32]*Host {
	if m != nil {
...
type Container struct {
	...
	AddressList []*ContainerAddr `protobuf:"bytes,27,rep,name=addressList" json:"addressList,omitempty"`
}
...
func (m *Container) GetAddressList() []*ContainerAddr {
	if m != nil {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if m.ConnectedHosts == nil {
				m.ConnectedHosts = make(map[int32]*Host)
			}
			if iNdEx < postIndex {
				var valuekey uint64
				for shift := uint(0); ; shift += 7 {
...
func (m *Container) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 27:
			...
			m.AddressList = append(m.AddressList, &ContainerAddr{})
...
var fileDescriptorAgent = []byte{
	...
	,
}
