...
type WatchedProcess struct {
	...
	Watching string `protobuf:"bytes,3,opt,name=watching,proto3" json:"watching,omitempty"`
}

func (m *WatchedProcess) Reset()                    { *m = WatchedProcess{} }
func (m *WatchedProcess) String() string            { return proto.CompactTextString(m) }
func (*WatchedProcess) ProtoMessage()               {}
func (*WatchedProcess) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{0} }
...
func (*ResCollector) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{1} }
...
func (*ResCollector_Header) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{1, 0} }
...
func (*CollectorProc) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{2} }
...
type CollectorRealTime struct {
	...
	WatchedResults []*WatchedResult `protobuf:"bytes,11,rep,name=watchedResults" json:"watchedResults,omitempty"`
}
...
func (m *CollectorRealTime) GetWatchedResults() []*WatchedResult {
	if m != nil {
		return m.WatchedResults
	}
	return nil
}

type WatchedResult struct {
	Process  *WatchedProcess `protobuf:"bytes,1,opt,name=process" json:"process,omitempty"`
	Result   string          `protobuf:"bytes,2,opt,name=result,proto3" json:"result,omitempty"`
	LastSeen int64           `protobuf:"varint,3,opt,name=lastSeen,proto3" json:"lastSeen,omitempty"`
}

func (m *WatchedResult) Reset()                    { *m = WatchedResult{} }
func (m *WatchedResult) String() string            { return proto.CompactTextString(m) }
func (*WatchedResult) ProtoMessage()               {}
func (*WatchedResult) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{5} }

func (m *WatchedResult) GetProcess() *WatchedProcess {
	if m != nil {
		return m.Process
	}
	return nil
...
func (*CollectorContainer) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{6} }
...
func (*CollectorContainerRealTime) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{7} }
...
func (*CollectorReqStatus) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{8} }

type CollectorStatus struct {
	ActiveClients int32             `protobuf:"varint,1,opt,name=activeClients,proto3" json:"activeClients,omitempty"`
	Interval      int32             `protobuf:"varint,2,opt,name=interval,proto3" json:"interval,omitempty"`
	Watched       []*WatchedProcess `protobuf:"bytes,3,rep,name=watched" json:"watched,omitempty"`
}
...
func (m *CollectorStatus) GetWatched() []*WatchedProcess {
	if m != nil {
		return m.Watched
	}
	return nil
...
func init() {
	proto.RegisterType((*WatchedProcess)(nil), "datadog.process_agent.WatchedProcess")
	...
	proto.RegisterType((*WatchedResult)(nil), "datadog.process_agent.WatchedResult")
...
func (m *WatchedProcess) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
...
func (m *WatchedProcess) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.Watching) > 0 {
		data[i] = 0x1a
		i++
		i = encodeVarintAgent(data, i, uint64(len(m.Watching)))
		i += copy(data[i:], m.Watching)
	}
	return i, nil
}
...
func (m *CollectorRealTime) MarshalTo(data []byte) (int, error) {
	...
	if len(m.WatchedResults) > 0 {
		for _, msg := range m.WatchedResults {
			data[i] = 0x5a
			i++
			i = encodeVarintAgent(data, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(data[i:])
...
func (m *WatchedResult) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *WatchedResult) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.Result) > 0 {
		data[i] = 0x12
		i++
		i = encodeVarintAgent(data, i, uint64(len(m.Result)))
...
func (m *Addr) MarshalTo(data []byte) (int, error) {
	...
	if m.Host != nil {
		...
		i++
		i = encodeVarintAgent(data, i, uint64(m.Host.Size()))
		n27, err := m.Host.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n27
...
func (m *WatchedProcess) Size() (n int) {
	var l int
	_ = l
	l = len(m.Hostname)
	if l > 0 {
...
func (m *CollectorRealTime) Size() (n int) {
	...
	if len(m.WatchedResults) > 0 {
		for _, e := range m.WatchedResults {
			l = e.Size()
			n += 1 + l + sovAgent(uint64(l))
		}
	}
...
func (m *WatchedResult) Size() (n int) {
	var l int
	_ = l
	if m.Process != nil {
		l = m.Process.Size()
...
func (m *WatchedProcess) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: WatchedProcess: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: WatchedProcess: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Watching", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Watching = string(data[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *CollectorRealTime) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WatchedResults", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.WatchedResults = append(m.WatchedResults, &WatchedResult{})
			if err := m.WatchedResults[len(m.WatchedResults)-1].Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *WatchedResult) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: WatchedResult: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: WatchedResult: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *CollectorStatus) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Watched", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Watched = append(m.Watched, &WatchedProcess{})
			if err := m.Watched[len(m.Watched)-1].Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorAgent = []byte{
	...
	,
}
