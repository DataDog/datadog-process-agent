...
type CollectorConnections struct {
	...
	// hostId
	ConnectedHosts map[string]*Host `protobuf:"bytes,7,rep,name=connectedHosts" json:"connectedHosts,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	// post-resolution field: all of the containers referenced in `connections` keyed by
	// containerId
	ConnectedContainers map[string]*ContainerMetadata `protobuf:"bytes,8,rep,name=connectedContainers" json:"connectedContainers,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (m *CollectorConnections) GetConnectedHosts() map[string]*Host {
	if m != nil {
...
func (m *CollectorConnections) GetConnectedContainers() map[string]*ContainerMetadata {
	if m != nil {
		return m.ConnectedContainers
	}
	return nil
}
...
// ContainerNetworkAddress records the IPs, Ports and Protocols for each container
...
func (m *ContainerNetworkAddress) Reset()                    { *m = ContainerNetworkAddress{} }
func (m *ContainerNetworkAddress) String() string            { return proto.CompactTextString(m) }
func (*ContainerNetworkAddress) ProtoMessage()               {}
func (*ContainerNetworkAddress) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{11} }
...
type Container struct {
	...
	AddressList []*ContainerNetworkAddress `protobuf:"bytes,27,rep,name=addressList" json:"addressList,omitempty"`
}
...
func (m *Container) GetAddressList() []*ContainerNetworkAddress {
	if m != nil {
...
type Connection struct {
	...
	BytesReceived float32          `protobuf:"fixed32,9,opt,name=bytesReceived,proto3" json:"bytesReceived,omitempty"`
...
type Addr struct {
	// post-resolution field; deprecated in favor of hostId
...
func init() {
	...
	proto.RegisterType((*ContainerNetworkAddress)(nil), "datadog.process_agent.ContainerNetworkAddress")
...
func (m *CollectorConnections) MarshalTo(data []byte) (int, error) {
	...
	if len(m.ConnectedHosts) > 0 {
		for k, _ := range m.ConnectedHosts {
			data[i] = 0x3a
			i++
			v := m.ConnectedHosts[k]
			msgSize := 0
			if v != nil {
				msgSize = v.Size()
	...
	if len(m.ConnectedContainers) > 0 {
		for k, _ := range m.ConnectedContainers {
			data[i] = 0x42
			i++
			v := m.ConnectedContainers[k]
			msgSize := 0
			if v != nil {
				msgSize = v.Size()
				msgSize += 1 + sovAgent(uint64(msgSize))
...
func (m *ContainerNetworkAddress) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *ContainerNetworkAddress) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *Connection) MarshalTo(data []byte) (int, error) {
	...
	if m.BytesSent != 0 {
		data[i] = 0x45
		i++
		i = encodeFixed32Agent(data, i, uint32(math.Float32bits(float32(m.BytesSent))))
	}
	if m.BytesReceived != 0 {
		data[i] = 0x4d
		i++
		i = encodeFixed32Agent(data, i, uint32(math.Float32bits(float32(m.BytesReceived))))
	}
	if m.Family != 0 {
		data[i] = 0x50
		i++
...
func (m *Addr) MarshalTo(data []byte) (int, error) {
	...
	if len(m.HostId) > 0 {
		data[i] = 0x22
		i++
		i = encodeVarintAgent(data, i, uint64(len(m.HostId)))
...
func (m *CollectorConnections) Size() (n int) {
	...
	if len(m.ConnectedHosts) > 0 {
		for k, v := range m.ConnectedHosts {
			_ = k
			_ = v
			l = 0
			if v != nil {
	...
	if len(m.ConnectedContainers) > 0 {
		for k, v := range m.ConnectedContainers {
			_ = k
			_ = v
			l = 0
			if v != nil {
...
func (m *ContainerNetworkAddress) Size() (n int) {
	var l int
	_ = l
	l = len(m.Ip)
	if l > 0 {
...
func (m *CollectorConnections) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ConnectedHosts", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ConnectedHosts == nil {
				m.ConnectedHosts = make(map[string]*Host)
			}
			if iNdEx < postIndex {
				var valuekey uint64
				for shift := uint(0); ; shift += 7 {
				...
				iNdEx = postmsgIndex
				m.ConnectedHosts[mapkey] = mapvalue
			} else {
				var mapvalue *Host
				m.ConnectedHosts[mapkey] = mapvalue
			}
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ConnectedContainers", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			mapkey := string(data[iNdEx:postStringIndexmapkey])
			iNdEx = postStringIndexmapkey
			if m.ConnectedContainers == nil {
				m.ConnectedContainers = make(map[string]*ContainerMetadata)
			}
			if iNdEx < postIndex {
				var valuekey uint64
				for shift := uint(0); ; shift += 7 {
				...
				iNdEx = postmsgIndex
				m.ConnectedContainers[mapkey] = mapvalue
			} else {
...
func (m *ContainerNetworkAddress) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ContainerNetworkAddress: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ContainerNetworkAddress: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *Container) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 27:
			...
			m.AddressList = append(m.AddressList, &ContainerNetworkAddress{})
...
func (m *Connection) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			v |= uint32(data[iNdEx-2]) << 16
			v |= uint32(data[iNdEx-1]) << 24
			m.BytesReceived = float32(math.Float32frombits(v))
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Family", wireType)
			}
...
var fileDescriptorAgent = []byte{
	...
	,
}
